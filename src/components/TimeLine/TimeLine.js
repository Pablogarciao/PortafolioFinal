...
const Timeline = () => {
  ...
  const scroll = (node, left) => {//es para que el timeline se mueva suavemente en mobile
  ...
  const handleScroll = () => {//esto es para que se active el punto del timeline que corresponde al texto que se esta viendo
    if (carouselRef.current) {
  ...
  return (
    <>
      ...
      <Section id="hobbies">
        ...
        <SectionText>
        I'm a very athletic person, I love riding bikes and going to the gym. I also love the agricultural sector and being out in the nature. I am a very social person and I love spending time with my friends and family.
